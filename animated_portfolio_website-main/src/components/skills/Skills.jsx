          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<FiFigma />} name={"Figma"} value={90} />
                <ProgressBar logo={<SiAdobecreativecloud />} name={"Adobe XD"} value={80} />
                <ProgressBar
                  logo={<FaSquareXTwitter/>}
                  name={"AxureRP9"}
                  value={70}
                />
                <ProgressBar logo={<IoLogoHtml5/>} name={"HTML/CSS"} value={50} />
                <ProgressBar
